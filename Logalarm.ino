...
void setup ()
{
	...
	pinMode (30, OUTPUT); // Set TX LED as an output
	//outputs
...
void GsmReceive ()
{
	...
	while (isRec == false)
	{
		...
		if (COMGSM.available ())
		{
		    ...
		    if (c == '\n')
			{
				if (isSms == true) {isSms = false; Serial.println ('#'); continue; }
				else isRec = true;
			}
